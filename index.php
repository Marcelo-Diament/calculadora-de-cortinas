      ...
      <section class="row">
        <article class="banner col-12" id="banner01">
          <div>
            ...
            <p>
              <a href="https://calculadora-de-cortina.com.br/#banner02" title="Saiba como medir sua cortina rapidinho!" alt="Saiba como medir sua cortina rapidinho!">
      ...
      <section class="row bannerDoisHome">
        <article class="banner col-12" id="banner02">
          <div>          
            ...
            <p>
              <a href="https://calculadora-de-cortina.com.br/calculo-de-cortina-linear.php" title="Calcule agora mesmo as medidas do tecido de sua cortina!" alt="Saiba como medir sua cortina rapidinho!">Medir agora!
