<?php
	...
	$subtitulo = "A Calculadora de Cortina calcula a quantia de tecido necessáiria para sua cortina e as medidas para o corte do tecido da cortina, além de prever  sobra de tecido da sua cortina.";
	$metaTitle = $titulo;
	$metaDesc = "A Calculadora de Cortina calcula a quantia de tecido necessáiria para sua cortina e as medidas para o corte do tecido da cortina, além de prever  sobra de tecido da sua cortina.";
	...
	$tiposdecortinas = array(
		...
		'subtitulo' => 'A Calculadora de Cortina calcula a quantia de tecido necessáiria para sua cortina linear e as medidas para o corte do tecido da cortina, além de prever  sobra de tecido da sua cortina linear.',
			...
			'metaDesc' => 'A Calculadora de Cortina calcula a quantia de tecido necessáiria para sua cortina linear e as medidas para o corte do tecido da cortina, além de prever  sobra de tecido da sua cortina linear.',
			'metaKeyWords' => 'calculadora de tecido, cálculo de tecido, conta de tecido, cálculo para cortina, conta para cortina, calculadora para cortina, quantidade de tecido para cortina, quantidade de tecido para corte de cortina, quantidade de tecido para orçamento',
